...
export const InfoCard = ({isImage = false, title, text, btnText, btnHref, extraTxt }: InfoCardProps) => {
    return (
        <div className="flex relative flex-col items-center justify-center linear-card w-full md:h-[580px] lg:h-[416px] md:px-0 px-4 py-4 rounded-[48px]">
            <Image src='/icons/big-circle.svg' alt='circle' width={400} height={400} className="absolute h-full w-full top-1/2 left-1/2 -translate-1/2 pointer-events-none select-none" />
            <Image src='/icons/medium-circle.svg' alt='circle' width={300} height={300} className="absolute h-full w-full  top-1/2 left-1/2 -translate-1/2 pointer-events-none select-none" />
            <Image src='/icons/small-circle.svg' alt='circle' width={200} height={200} className="absolute h-full w-full top-1/2 left-1/2 -translate-1/2 pointer-events-none select-none" />
